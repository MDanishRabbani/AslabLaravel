...
<body class="bg-gray-100 text-gray-900 dark:bg-gray-900 dark:text-gray-100">
    <div class="container mx-auto p-6">
        ...
        <h3 class="text-xl font-semibold mb-4">Data Pegawai</h3>
        ...
        <form action="/pegawai/store" method="post" class="bg-white p-6 rounded-lg shadow-md dark:bg-gray-800">
            {{ csrf_field() }}
            
            <div class="mb-4">
                <label for="nama" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Nama</label>
                <input type="text" id="nama" name="nama" required="required" class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm dark:border-neutral-600 dark:bg-gray-700 dark:text-gray-300 dark:focus:ring-blue-400 dark:focus:border-blue-400">
            </div>

            <div class="mb-4">
                <label for="jabatan" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Jabatan</label>
                <input type="text" id="jabatan" name="jabatan" required="required" class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm dark:border-neutral-600 dark:bg-gray-700 dark:text-gray-300 dark:focus:ring-blue-400 dark:focus:border-blue-400">
            </div>

            <div class="mb-4">
                <label for="umur" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Umur</label>
                <input type="number" id="umur" name="umur" required="required" class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm dark:border-neutral-600 dark:bg-gray-700 dark:text-gray-300 dark:focus:ring-blue-400 dark:focus:border-blue-400">
            </div>
